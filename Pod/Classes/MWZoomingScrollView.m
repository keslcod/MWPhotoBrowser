...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		_tapView.backgroundColor = _photoBrowser.backgroundColor;
		...
		_photoImageView.backgroundColor = _photoBrowser.backgroundColor;
		...
		_loadingIndicator.progressTintColor = _photoBrowser.barTintColor;
		...
		// Setup
		self.backgroundColor = _photoBrowser.backgroundColor;
		self.delegate = self;
